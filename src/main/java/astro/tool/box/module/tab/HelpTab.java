...
public class HelpTab {
    ...
    public void init() {
        try {
            ...
            text.row("containing your object in a field of view of 30 arcseconds. The field of view can be changed by spinning the mouse wheel forward (larger) or backward (smaller),");
