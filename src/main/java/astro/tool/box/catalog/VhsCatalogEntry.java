...
public class VhsCatalogEntry implements CatalogEntry {
	...
	public void loadCatalogElements() {
		...
		catalogElements
				.add(new CatalogElement("Y (mag)", roundTo4DecNZ(y_ap3), Alignment.RIGHT, getDoubleComparator(), true));
		catalogElements
				.add(new CatalogElement("Y err", roundTo4DecNZ(y_ap3_err), Alignment.RIGHT, getDoubleComparator()));
		catalogElements
		...
		catalogElements
				.add(new CatalogElement("H (mag)", roundTo4DecNZ(h_ap3), Alignment.RIGHT, getDoubleComparator(), true));
		catalogElements
				.add(new CatalogElement("H err", roundTo4DecNZ(h_ap3_err), Alignment.RIGHT, getDoubleComparator()));
		catalogElements.add(
		...
		catalogElements
				.add(new CatalogElement("H-Ks", roundTo4DecNZ(h_ks_pnt), Alignment.RIGHT, getDoubleComparator()));
		catalogElements
	...
	private String createAltCatalogQuery() {
		...
		addRow(query, "WHERE  't'=q3c_radial_query(ra2000, dec2000, " + ra + ", " + dec + ", "
	...
	public String[] getColumnValues() {
		String columnValues = roundTo3DecLZ(getTargetDistance()) + "," + sourceId + "," + roundTo6Dec(ra) + ","
				+ roundTo6Dec(dec) + "," + TYPE_TABLE.get(objectType) + "," + roundTo4Dec(y_ap3) + ","
				+ roundTo4Dec(y_ap3_err) + "," + roundTo4Dec(j_ap3) + "," + roundTo4Dec(j_ap3_err) + ","
				+ roundTo4Dec(h_ap3) + "," + roundTo4Dec(h_ap3_err) + "," + roundTo4Dec(ks_ap3) + ","
				+ roundTo4Dec(ks_ap3_err) + "," + roundTo4Dec(y_j_pnt) + "," + roundTo4Dec(j_h_pnt) + ","
				+ roundTo4Dec(h_ks_pnt) + "," + roundTo4Dec(j_ks_pnt);
