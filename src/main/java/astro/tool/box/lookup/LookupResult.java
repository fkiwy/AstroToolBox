...
public class LookupResult {
	...
	public int hashCode() {
		...
		hash = 17 * hash
				+ (int) (Double.doubleToLongBits(this.colorValue) ^ (Double.doubleToLongBits(this.colorValue) >>> 32));
		...
		hash = 17 * hash
				+ (int) (Double.doubleToLongBits(this.nearest) ^ (Double.doubleToLongBits(this.nearest) >>> 32));
