...
public class CollectedObject {
	...
	public String toString() {
		return "CollectedObject{" + "discoveryDate=" + discoveryDate + ", objectType=" + objectType + ", catalogName="
				+ catalogName + ", ra=" + ra + ", dec=" + dec + ", sourceId=" + sourceId + ", plx=" + plx + ", pmra="
				+ pmra + ", pmdec=" + pmdec + ", spectralTypes=" + spectralTypes + ", notes=" + notes + '}';
	}
	...
	public String getValues() {
		String values = discoveryDate.format(DATE_TIME_FORMATTER) + "," + objectType + "," + catalogName + ","
				+ roundTo7Dec(ra) + "," + roundTo7Dec(dec) + "," + sourceId + "," + roundTo4Dec(plx) + ","
				+ roundTo3Dec(pmra) + "," + roundTo3Dec(pmdec) + "," + joinSpetralTypes() + "," + notes;
		return values;
	}
	...
	public static class Builder {
		...
		public CollectedObject build() {
			return new CollectedObject(discoveryDate, objectType, catalogName, ra, dec, sourceId, plx, pmra, pmdec,
					spectralTypes, notes);
		}
