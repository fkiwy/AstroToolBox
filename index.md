...
Download latest version: [AstroToolBox-2.3.6.jar](jar-files/AstroToolBox-2.3.6.jar)
...
- Image Viewer tab: Added 2 experimental features that work only with catalog overlays:
  - a checkbox to display estimated spectral types
  - a checkbox to show potential brown dwarfs only
...
- Added buttons "Save as PNG" and "Save as GIF" to the Image Viewer tab.
  - The first button saves the current image as a PNG file.
  - The second button saves all the images as an animated GIF.
