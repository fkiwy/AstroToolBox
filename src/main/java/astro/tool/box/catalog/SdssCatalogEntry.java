...
public class SdssCatalogEntry implements CatalogEntry, Extinction {
	...
	public void loadCatalogElements() {
		...
		catalogElements.add(
				new CatalogElement("ra err (arcsec)", roundTo7DecNZ(raErr), Alignment.LEFT, getDoubleComparator()));
		catalogElements.add(new CatalogElement("dec", roundTo7DecNZ(dec), Alignment.LEFT, getDoubleComparator()));
		catalogElements.add(
				new CatalogElement("dec err (arcsec)", roundTo7DecNZ(decErr), Alignment.LEFT, getDoubleComparator()));
		catalogElements.add(
				new CatalogElement("object type", OBJECT_TYPES.get(type), Alignment.LEFT, getStringComparator(), true));
		catalogElements.add(new CatalogElement("photometry flag", getSdssPhotometryFlag(clean), Alignment.LEFT,
				getStringComparator(), true));
		catalogElements.add(new CatalogElement("observation date", mjd.format(DATE_FORMATTER), Alignment.LEFT,
				getStringComparator()));
		catalogElements.add(new CatalogElement("spectrum pointer", String.valueOf(specObjID), Alignment.LEFT,
				getStringComparator()));
		catalogElements
	...
	public String[] getColumnValues() {
		String columnValues = roundTo3DecLZ(getTargetDistance()) + "," + objID + "," + roundTo7Dec(ra) + ","
				+ roundTo7Dec(raErr) + "," + roundTo7Dec(dec) + "," + roundTo7Dec(decErr) + "," + OBJECT_TYPES.get(type)
				+ "," + getSdssPhotometryFlag(clean) + "," + mjd.format(DATE_FORMATTER) + "," + specObjID + ","
				+ roundTo3Dec(u_mag) + "," + roundTo3Dec(u_err) + "," + roundTo3Dec(g_mag) + "," + roundTo3Dec(g_err)
				+ "," + roundTo3Dec(r_mag) + "," + roundTo3Dec(r_err) + "," + roundTo3Dec(i_mag) + ","
				+ roundTo3Dec(i_err) + "," + roundTo3Dec(z_mag) + "," + roundTo3Dec(z_err) + ","
