...
public class TwoMassCatalogEntry implements CatalogEntry, Extinction {
	...
	public static String createToolTip_ph_qual() {
		String toolTip = "<b>Photometric quality flag (ph. qual.):</b>" + LINE_BREAK +
				...
				NEW_LINE +
				"A value of ph_qual=\"U\" does not necessarily mean that there is no flux detected in this band at the location." +
				NEW_LINE +
				"Whether or not flux has been detected can be determined from the value of rd_flg. When rd_flg=\"0\", no flux has been detected." +
				NEW_LINE +
				"When rd_flg=\"6\", flux has been detected at the location where the images were not deblended consistently in all three bands (JHKs)." +
				LINE_BREAK +
				...
				NEW_LINE +
				"The uncertainties reported for these sources in [jhk]_cmsig and [jhk]_msigcom are flags and have numeric values &gt; 8.0." +
				LINE_BREAK +
				...
				NEW_LINE +
				"or detections where psf fit photometry did not converge and an aperture magnitude is reported (rd_flg=4)," +
				NEW_LINE +
				"or detections where the number of frames was too small in relation to the number of frames in which a detection was geometrically possible (rd_flg=\"1\" or rd_flg=\"2\")." +
				LINE_BREAK +
	...
	public static String createToolTip_rd_flg() {
		String toolTip = "<b>Read flag:</b>" + LINE_BREAK +
				...
				NEW_LINE +
				" of the source on the Atlas Image. The sky background is estimated in an annular region with inner radius of 14\" and outer radius of 20\"." +
				LINE_BREAK +
				"\"1\" - The default magnitude is derived from aperture photometry measurements on the 51 ms \"Read_1\" exposures." +
				NEW_LINE +
				"The aperture radius is 4\", with the sky background measured in an annulus with an inner radius of 14\" and an outer radius of 20\"." +
				NEW_LINE +
				"Used for sources that saturate one or more of the 1.3s \"Read_2\" exposures, but are not saturated on at least one of the 51 ms \"Read_1\" frames." +
				LINE_BREAK +
				"\"2\" - The default magnitude is derived from a profile-fitting measurement made on the 1.3 sec \"Read_2\" exposures." +
				NEW_LINE +
				"The profile-fit magnitudes are normalized to curve-of-growth-corrected aperture magnitudes." +
				NEW_LINE +
				"This is the most common type in the PSC, and is used for sources that have no saturated pixels in any of the 1.3 sec exposures." +
				LINE_BREAK +
				"\"3\" - The default magnitude is derived from a 1-d radial profile fitting measurement made on the 51 ms \"Read_1\" exposures." +
				NEW_LINE +
				"Used for very bright sources that saturate all of the 51 ms \"Read 1\" exposures." +
				LINE_BREAK +
				...
				NEW_LINE + "This is used for sources that are not saturated in any of the Read_2 frames," +
				NEW_LINE +
				"but where the profile-fitting measurements fail to converge to a solution. These magnitudes are the same as the standard aperture magnitudes (j_m_stdap, h_m_stdap, k_m_stdap)," +
				NEW_LINE +
				"but when they are the default magnitudes, it generally implies that they are low quality measurements." +
				LINE_BREAK +
				...
				NEW_LINE +
				"The sky background is estimated in an annular region with inner radius of 14\" and outer radius of 20\"." +
				NEW_LINE +
				"This is used for pairs of sources which are detected and resolved in another band, but are detected and not resolved in this band." +
				NEW_LINE +
				"This differs from a rd_flg=\"0\" because in this case there is a detection of the source in this band, but it is not consistently resolved across all bands." +
				LINE_BREAK +
				...
				"The sky background is estimated in an annular region with inner radius of 14\" and outer radius of 20\"." +
				NEW_LINE +
				"This is used for sources that were nominally detected in this band, but which could not have a useful brightness measurement from either profile fitting or aperture photometry." +
				NEW_LINE +
				"This often occurs in highly confused regions, or very near Tile edges where a significant fraction of the measurement aperture of sky annulus falls off the focal plane.";
		return toolTip;
	}

	public static String createToolTip_bl_flg() {
		String toolTip = "<b>Blend flag:</b>" + LINE_BREAK +
				...
				NEW_LINE + "or saturated star 1-d radial profile-fitting (rd_flg=\"3\")." +
				LINE_BREAK +
				...
				NEW_LINE +
				"The maximum number of components is 7 in any band for the PSC, so this bl_flg is always a three character flag." +
				NEW_LINE +
				"Multi-component fitting occurs only for profile-fitting, and only when more than one detection is found within ~5\"." +
				NEW_LINE + "Single detections that are not well-fit by a single PSF are not split.";
		return toolTip;
	}
	...
	public static String createToolTip_cc_flg() {
		String toolTip = "<b>Contamination and confusion flags (cc flags):</b>" + LINE_BREAK +
				...
				NEW_LINE + "This is very common in high source density regions." + LINE_BREAK +
				...
				NEW_LINE +
				"there was more than one possible match between the different band components." +
				NEW_LINE +
	...
	public static String createToolTip_gal_contam() {
		String toolTip = "<b>Extended source flag (ext. flag):</b>" + LINE_BREAK +
				...
				NEW_LINE +
				"or it is not identified exactly with an XSC source with semi-major axis &gt; 10''." +
				NEW_LINE + "However, the source may correspond exactly to a smaller XSC source." +
				LINE_BREAK +
	...
	public static String createToolTip_mp_flg() {
		String toolTip = "<b>Minor planet flag:</b>" + LINE_BREAK +
