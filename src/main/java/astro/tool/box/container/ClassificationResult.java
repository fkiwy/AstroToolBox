...
public class ClassificationResult {
	...
	public String getValues() {
		String values = catalogName + "," + roundTo7Dec(targetRa) + "," + roundTo7Dec(targetDec) + ","
	...
	public static class Builder {
		...
		public ClassificationResult build() {
			return new ClassificationResult(catalogName, targetRa, targetDec, targetDistance, ra, dec, sourceId, plx,
					pmra, pmdec, magnitudes, spectralTypes);
		}
