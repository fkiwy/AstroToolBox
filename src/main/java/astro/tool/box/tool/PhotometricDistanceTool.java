	...
	public void init() {
		try {
			...
			mainPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(),
					"Photometric distance calculator", TitledBorder.LEFT, TitledBorder.TOP));
			...
			calculateButton.addActionListener((ActionEvent e) -> {
				try {
					...
					double distanceError = calculatePhotometricDistanceError(apparentMagnitude, apparentMagnitudeError,
