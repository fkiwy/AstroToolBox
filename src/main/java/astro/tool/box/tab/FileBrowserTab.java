...
public class FileBrowserTab implements Tab {
	...
	public FileBrowserTab(JFrame baseFrame, JTabbedPane tabbedPane, CatalogQueryTab catalogQueryTab,
	...
	private void displayQueryResults(String[] columnNames, List<String[]> rows) {
		...
		resultScrollPanel.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), file.getName(),
